    ...
    void Game::initMap()
    {
        ...
        TileMap[10] = "B      BD                                B";
        TileMap[11] = "B  D   BBB         BBBBBBB            A  B";/*Ð·Ð´ÐµÑÑŒ Ð±ÑƒÐ´ÐµÑ‚ Ð²Ñ‹Ñ…Ð¾Ð´*/
    ...
    void Game::drawBackground(sf::RenderWindow& window) {
        ...
        mBackgroundSprite.setTexture(mBackgroundTexture); // Ð˜ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐ¹Ñ‚Ðµ ÑƒÐ¶Ðµ ÑÑƒÑ‰ÐµÑÑ‚Ð²ÑƒÑŽÑ‰Ð¸Ð¹ ÑÐ¿Ñ€Ð°Ð¹Ñ‚, Ð° Ð½Ðµ ÑÐ¾Ð·Ð´Ð°Ð²Ð°Ð¹Ñ‚Ðµ Ð½Ð¾Ð²Ñ‹Ð¹
    ...
    void Game::render()
    {
        ...
        sf::Text healthText("Çäîðîâüå: " + std::to_string(health), font, 20);
        healthText.setFillColor(sf::Color::Black);
        healthText.setPosition(mPlayer.getPosition().x, mPlayer.getPosition().y - 50);
           
        
        sf::Text missionText("Çàâåðøèòå èãðó ñ íóëåâûì ñ÷¸òîì ", font, 20);
